  ...
  return (
    <header className="header">
      ...
      <div className="header-actions">
        <div className={`live-status ${serverOnline ? "online" : "offline"}`}>
        ...
        {notificationsOpen && (
          <div className="notification-panel" role="status">
            <div className="notification-panel-header">
              ...
              <span>{serverOnline ? "Live" : "Unavailable"}</span>
            </div>

            <div className="notification-item">
              {serverOnline ? <CheckCircle2 size={17} /> : <XCircle size={17} />}
              <div>
                <strong>
                  {serverOnline ? "Backend connected" : "Backend unavailable"}
                </strong>
                <small>
                  {serverOnline
            ...
            {serverOnline && (
              <div className="notification-meta">
                <span>Model 1</span>
                <strong>{health.model1_loaded ? "Loaded" : "Missing"}</strong>
                <span>Model 2</span>
                <strong>{health.model2_loaded ? "Loaded" : "Missing"}</strong>
              </div>
            )}
          </div>
        )}
